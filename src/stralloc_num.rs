...
#[no_mangle]
pub unsafe extern fn stralloc_catulong0(
    mut sa : *mut stralloc, mut u : usize, mut n : u32
) -> i32 {
    let mut len : u32;
    let mut q : usize;
    let mut s : *mut u8;
...
#[no_mangle]
pub unsafe extern fn stralloc_catlong0(
    mut sa : *mut stralloc, mut l : isize, mut n : u32
) -> i32 {
    if l < 0isize {
