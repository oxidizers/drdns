...
#[no_mangle]
pub unsafe extern fn printrecord_cat(
                       ...
                       if !x.is_null() {
                           ...
                           if stralloc_cats(out,(*b" SOA \0").as_ptr()) == 0 {
                               ...
                               if pos == 0 {
                                   ...
                                   if pos == 0 {
                                       ...
                                       pos = dns_packet_copy(buf,len,pos,misc.as_mut_ptr(),20u32);
                                       if pos == 0 {
                                           return 0u32;
                                       } else {
                                           i = 0i32;
                           ...
                           if stralloc_catulong0(out,u16 as (usize),0u32) == 0 {
                               ...
                               'loop22: loop {
                                   ...
                                   if misc[0usize] as (i32) >= 33i32 && (misc[
                                                                             0usize
                                                                         ] as (i32) <= 126i32) && (misc[
                                                                                                       0usize
                                                                                                   ] as (i32) != b'\\' as (i32)) {
                                       ...
                                       misc[
                                           3usize
                                       ] = (b'0' as (i32) + (7i32 & ch as (i32))) as (u8);
...
#[no_mangle]
pub unsafe extern fn printrecord(
    mut out : *mut stralloc,
    mut buf : *const u8,
    mut len : u32,
    mut pos : u32,
