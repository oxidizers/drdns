...
unsafe extern fn roots_find(mut q : *mut u8) -> i32 {
...
#[no_mangle]
pub unsafe extern fn roots(
    mut servers : *mut u8, mut q : *mut u8
) -> i32 {
    let mut r : i32;
    r = roots_find(q);
    if r == -1i32 {
...
unsafe extern fn roots_search(mut q : *mut u8) -> i32 {
    let mut _currentBlock;
    let mut r : i32;
    'loop1: loop {
        r = roots_find(q);
...
#[no_mangle]
pub unsafe extern fn roots_same(
    mut q : *mut u8, mut q2 : *mut u8
) -> i32 {
...
unsafe extern fn init2(mut dir : *mut Struct1) -> i32 {
    let mut _currentBlock;
...
#[no_mangle]
pub unsafe extern fn roots_init() -> i32 {
    let mut fddir : i32;
    let mut r : i32;
    if stralloc_copys(
           &mut data as (*mut stralloc),
