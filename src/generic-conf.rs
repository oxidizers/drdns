...
#[no_mangle]
pub unsafe extern fn init(mut d : *const u8, mut f : *const u8) {
    dir = d;
    fatal = f;
    umask(0o22u16);
...
#[no_mangle]
pub unsafe extern fn makedir(mut s : *const u8) {
    fn_ = s;
...
#[no_mangle]
pub unsafe extern fn start(mut s : *const u8) {
    fn_ = s;
    fd = open_trunc(fn_);
    if fd == -1i32 {
        fail();
...
#[no_mangle]
pub unsafe extern fn outs(mut s : *const u8) {
...
#[no_mangle]
pub unsafe extern fn out(mut s : *const u8, mut len : u32) {
...
#[no_mangle]
pub unsafe extern fn copyfrom(mut b : *mut buffer) {
...
#[no_mangle]
pub unsafe extern fn perm(mut mode : i32) {
...
#[no_mangle]
pub unsafe extern fn owner(mut uid : i32, mut gid : i32) {
...
#[no_mangle]
pub unsafe extern fn makelog(
    mut user : *const u8, mut uid : i32, mut gid : i32
) {
