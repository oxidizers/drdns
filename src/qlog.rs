...
unsafe extern fn octal(mut c : u8) {
    put(b'\\');
    ...
    if *q == 0 {
        ...
        'loop1: loop {
            ...
            'loop2: loop {
                ...
                if ch2 as (i32) >= b'a' as (i32) && (ch2 as (i32) <= b'z' as (i32)) || ch2 as (i32) >= b'0' as (i32) && (ch2 as (i32) <= b'9' as (i32)) || ch2 as (i32) == b'-' as (i32) || ch2 as (i32) == b'_' as (i32) {
                    put(ch2);
                } else {
                    octal(ch2);
                }
