...
unsafe extern fn init(mut rules : *mut stralloc) -> i32 {
                            ...
                            if host[i as (usize)] != 0 {
                                if stralloc_copys(rules,(*b"?:\0").as_ptr()) == 0 {
                                    return -1i32;
                                              ...
                                              rules,
                                              host.as_mut_ptr().offset(i as (isize)) as (*const u8)
                                          ) == 0 {
                                    return -1i32;
                                } else if stralloc_append(rules,(*b"\0").as_ptr()) == 0 {
                                    return -1i32;
...
#[no_mangle]
pub unsafe extern fn dns_resolvconfrewrite(
