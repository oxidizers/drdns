...
unsafe extern fn string(mut s : *const u8) {
    buffer_puts(buffer_2,s);
}

unsafe extern fn line() {
    string((*b"\n\0").as_ptr());
    buffer_flush(buffer_2);
}

#[no_mangle]
pub unsafe extern fn log_startup() {
    string((*b"starting\0").as_ptr());
    line();
}

unsafe extern fn u64_print() {
    let mut buf : [u8; 20];
    let mut pos : u32;
    ...
    buffer_put(
        ...
        ::std::mem::size_of::<[u8; 20]>().wrapping_sub(
            pos as (usize)
        ) as (u32)
    );
}

unsafe extern fn space() {
    string((*b" \0").as_ptr());
}

unsafe extern fn hex(mut c : u8) {
    buffer_put(
        buffer_2,
        (*b"0123456789abcdef\0").as_ptr().offset(
            (c as (i32) >> 4i32) as (isize)
        ),
        1u32
    );
    buffer_put(
        buffer_2,
        (*b"0123456789abcdef\0").as_ptr().offset(
            (c as (i32) & 15i32) as (isize)
        ),
        1u32
    );
}

unsafe extern fn ip(mut i : *const u8) {
    hex(*i.offset(0isize));
    hex(*i.offset(1isize));
    hex(*i.offset(2isize));
    hex(*i.offset(3isize));
...
unsafe extern fn logid(mut id : *const u8) {
    hex(*id.offset(0isize));
    hex(*id.offset(1isize));
}

unsafe extern fn logtype(mut type_ : *const u8) {
    let mut u : u16;
...
unsafe extern fn name(mut q : *const u8) {
    let mut ch : u8;
    let mut state : i32;
    if *q == 0 {
        string((*b".\0").as_ptr());
...
#[no_mangle]
pub unsafe extern fn log_query(
    mut qnum : *mut usize,
    mut client : *const u8,
    mut port : u32,
    mut id : *const u8,
...
#[no_mangle]
pub unsafe extern fn log_querydone(
    mut qnum : *mut usize, mut len : u32
) {
...
#[no_mangle]
pub unsafe extern fn log_querydrop(mut qnum : *mut usize) {
...
#[no_mangle]
pub unsafe extern fn log_tcpopen(
    mut client : *const u8, mut port : u32
) {
...
#[no_mangle]
pub unsafe extern fn log_tcpclose(
    mut client : *const u8, mut port : u32
) {
    let mut x : *const u8 = error_str(errno);
...
#[no_mangle]
pub unsafe extern fn log_cachedanswer(
    mut q : *const u8, mut type_ : *const u8
) {
...
#[no_mangle]
pub unsafe extern fn log_cachedcname(
    mut dn : *const u8, mut dn2 : *const u8
) {
...
#[no_mangle]
pub unsafe extern fn log_cachedns(
    mut control : *const u8, mut ns : *const u8
) {
...
#[no_mangle]
pub unsafe extern fn log_cachednxdomain(mut dn : *const u8) {
...
#[no_mangle]
pub unsafe extern fn log_nxdomain(
    mut server : *const u8, mut q : *const u8, mut ttl : u32
) {
...
#[no_mangle]
pub unsafe extern fn log_nodata(
    mut server : *const u8,
    mut q : *const u8,
    mut qtype : *const u8,
    mut ttl : u32
...
#[no_mangle]
pub unsafe extern fn log_servfail(mut dn : *const u8) {
    let mut x : *const u8 = error_str(errno);
...
#[no_mangle]
pub unsafe extern fn log_rrcname(
    mut server : *const u8,
    mut q : *const u8,
    mut data : *const u8,
    mut ttl : u32
...
#[no_mangle]
pub unsafe extern fn log_rrptr(
    mut server : *const u8,
    mut q : *const u8,
    mut data : *const u8,
    mut ttl : u32
...
#[no_mangle]
pub unsafe extern fn log_rrsoa(
    mut server : *const u8,
    mut q : *const u8,
    mut n1 : *const u8,
    mut n2 : *const u8,
...
#[no_mangle]
pub unsafe extern fn log_stats() {
