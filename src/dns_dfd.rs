...
#[no_mangle]
pub unsafe extern fn dns_domain_fromdot(
    mut out : *mut *mut u8, mut buf : *const u8, mut n : u32
) -> i32 {
    ...
    'loop1: loop {
        ...
        if ch as (i32) == b'.' as (i32) {
            ...
            if namelen.wrapping_add(labellen).wrapping_add(
                   1u32
            ...
            if ch as (i32) == b'\\' as (i32) {
                ...
                if ch as (i32) >= b'0' as (i32) && (ch as (i32) <= b'7' as (i32)) {
                    ...
                    if n != 0 && (*buf as (i32) >= b'0' as (i32)) && (*buf as (i32) <= b'7' as (i32)) {
